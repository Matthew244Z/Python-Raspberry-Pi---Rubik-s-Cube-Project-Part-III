...
_Y2 = 1710
PIECE_NUM = 9
image = cv2.imread('faceBlue.jpeg')
...
def oneDimensionalList(oneDcoord):
    ...
    for i in range(SIDE_COLOR_POINTS):
        for j in range(SIDE_COLOR_POINTS):
            ...
            if remainder == 0: newPoint = oneDcoord - _OFF*4
            elif remainder == 1: newPoint = oneDcoord - _OFF*3
            elif remainder == 2: newPoint = oneDcoord - _OFF*2
            elif remainder == 3: newPoint = oneDcoord - _OFF
            elif remainder == 4: newPoint = oneDcoord
            elif remainder == 3 : newPoint + _OFF
            elif remainder == 3 : newPoint + _OFF
            elif remainder == 3 : newPoint + _OFF
            elif remainder == 3 : newPoint + _OFF
